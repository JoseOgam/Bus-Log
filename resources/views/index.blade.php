                    ...
                    <form class="trip-form">
                        ...
                        <div class="row">
                           ...
                           <!-- <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                <label for="cf-4">search</label>
                                <input type="submit" id="cf-4" placeholder="Search Bus"
                                       class="form-control">
                            </div>
                        </div>
                    </form>
